 ...
 useShinyalert(),
  ...
  navbarPage("EcTracker",
                   tabPanel("Home" ,icon = icon("home"),
                          ...
                          column(8, align="center", offset = 2 ,h6("Developed by:"), tags$u( h6("Vishakha Gautam")),tags$u(h6("Siddhant Kalra")),

                          br(),h6("For more details:"),
                          tags$head(tags$style(HTML("a {color: blue}"))),
                          h6(tags$a(href="https://ahuja-lab.in/", "The Ahuja Lab", style = "color:yellow")))
                     ...
                     tabPanel(tags$b("1. Upload") ,
                                 ...
                                 # 
                                    ...
                                    fileInput("file","Upload Expression Matrix (Maximum Size Limit is 10 GB)"),
                                            ...
                                            h5("OR"),br(),
                                            fileInput("File10","Upload 10X Genomics Data Files (barcode.tsv, genes.tsv & matrix.mtx) ", multiple = TRUE),

                                            checkboxInput("testme", "Sample Data ",
                                                          value = FALSE),tags$a(href="https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE106888", "GSE106888", style = "color:yellow"),

                                            
                                    # checkboxInput("testme2", "Sample Data 2",
                                    #               value = FALSE),
                                    br(),br(),
                                    fileInput("meta","Upload Metadata File "),
                                    checkboxInput("testme3", "Sample Metadata File",
                                                  value = FALSE),
                                    # checkboxInput("testme4", "Sample Meta file 2",
                                    #               value = FALSE),
                                    br(),br(),
...
tabsetPanel(type = "tabs",
            ...
            tabPanel("Method 1 (faster & abstract)",
                    ...
                    br(), downloadButton(outputId="drop_clust_scatter","Download Plot"),
                     ...
                     withLoader(verbatimTextOutput("dex_scatter"),type="image",loader = "Asset 1.jpg"),
                     br(),br(),
                     h6("Clustering"),
                     ...
                     br(), downloadButton(outputId="sce_silhouette_d","Download Plot"),
            ...
            tabPanel("Method 2 (slower & comprehensive)",
                     ...
                     # checkboxInput("CCA_use", "Use CCA for Batch Correction",
                     #               value = FALSE),
                     # checkboxInput("SCT_use", "Use ScTransform for Batch Correction",
                     #                                            value = FALSE),
                     br(),
         ...
         tabsetPanel(type = "tabs",
                     ...
                     tabPanel("Method 1 (faster & abstract)",
                             ...
                             br(), h6("For this step, please upload the metadata file in Upload Section"),br(),br(),
                              ...
                              actionButton("Batch_Correction_method_dropclust1","Merge Metadata File"),
                     ...
                     tabPanel("Method 2 (slower & comprehensive)",
                              ...
                              # tabsetPanel(type="tabs",
                                   ...
                                   tabPanel("Harmony",
                                            ...
                                            actionButton("Batch_Correction_method1","Merge Metadata File"),
                                   ...
                                   #,
                                   # 
                                   # tabPanel("Integrated Seurat",
                                   #          br(),
                                   #          h6("For this step please upload the meta file in Upload Section"),br(),br(),
                                   #          actionButton("Batch_Correction_method2","Merge Meta File"),
                                   #          withLoader( uiOutput("meta_info2"),type="image",loader = "Asset 1.jpg"),
                                   # 
                                   #          br(),br(),
                                   # 
                                   #          actionButton("seurat_int1","Batch Correction"),
                                   # 
                                   #          withLoader(plotOutput("seurat_integrated_plot"),type="image",loader = "Asset 1.jpg")
                                   # 
                                   # 
                                   #          )
                                   # ),
                    ...
                    tabPanel(tags$b("4. DEG Analysis"),
                             tabsetPanel(type = "tabs",
                                         

                                         tabPanel("Method 1 (faster & abstract)",
                               br(),
                               h6("Differentially Expressed Gene"),br(),
                            ...
                            br(),br(),
                               ...
                               h6("Display Markers"),
                               # sliderInput("sce_marker", "Select Cluster Number",
                               #             min = 0, max = 20,step=1,
                               #             value = 1),
                              ...
                              textInput("feature_plot_sce","Enter Gene Name"),
                              
                              withLoader(plotOutput("feature_plot_result_sce"),type="image",loader = "Asset 1.jpg"),
                              #br(),downloadButton(outputId="sce_feature_plot_d","Download Plot"),
                            br(),br(),
