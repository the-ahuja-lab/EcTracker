                     ...
                     tabPanel(tags$b("1. Upload") ,
                                  ...
                                  mainPanel(
                                    ...
                                    fileInput("file","Upload Expression Matrix (Maximum Size Limit is 10 GB)"),
                                            ...
                                            h5("OR"),br(),
                                            fileInput("File10","Upload 10x Genomics Data Files (barcodes.tsv, genes.tsv & matrix.mtx) ", multiple = TRUE),
                                    h6("Note: File names in Upload 10x Genomics Data Files should be barcodes.tsv, genes.tsv & matrix.mtx"),

                                            checkboxInput("testme", "Sample Data ",
                                                          value = FALSE),
                                    tags$a(href="https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE73122;", "GSE73122", style = "color:yellow"),
...
tabsetPanel(type = "tabs",
            ...
            tabPanel("Method 1 (faster & abstract)",
                     br(),
                     checkboxInput("ERCC2", "Include spike-ins for QC",
                                   value = FALSE),
                  
                     checkboxInput("low_seq_depth1", "Filter Out Low Sequencing Depth Cells (Require Mapped_reads Information in metadata file)",
                                   value = FALSE),
            ...
            tabPanel("Method 2 (slower & comprehensive)",
                     ...
                     sliderInput("min_features", "Minimum Number of Features",
                                 ...
                                 value = 200),
                     checkboxInput("ERCC", "Include spike-ins for QC",
                                   value = FALSE),
                     checkboxInput("low_seq_depth", "Filter Out Low Sequencing Depth Cells (Require Mapped_reads Information in metadata file)",
                                   value = FALSE),
                    ...
                    br(),br(),
                    checkboxInput("vars_regress", "Regrees out Variables",
              value = FALSE),
