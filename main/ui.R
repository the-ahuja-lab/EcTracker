                     ...
                     tabPanel(tags$b("1. Upload") ,
                                  ...
                                  mainPanel(
                                    ...
                                    fileInput("file","Upload Expression Matrix (Maximum Size Limit is 10 GB)"),
                                            ...
                                            h4("OR"),br(),
                                    h5("Upload 10x Genomics Data Files"),
                                    fileInput("File100"," Upload barcodes.tsv File"),  
                                    downloadLink('barcode', 'Download Sample File', class = "butt",style = "color:yellow"),
                                    br(),
                                    fileInput("File101","Upload genes.tsv File"),
                                    downloadLink('genes', 'Download Sample File', class = "butt",style = "color:yellow"),
                                    br(),
                                    fileInput("File102","Upload matrix.mtx File"),
                                    downloadLink('matrix', 'Download Sample File', class = "butt",style = "color:yellow"),
                                    br(),
